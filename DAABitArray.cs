...
namespace Asgn
{
    ...
    public class DAABitArray
    {
        ...
        //sorry for butchering patrick's code. this just made it easier to debug...
        //with this I can hover over a bitarray while debugging and it shows me it as a string of 0s and 1s :D
        public override String ToString()
        {
            StringBuilder output = new StringBuilder();
            foreach(bool curr in m_bits)
            {
                //true == 1
                if(curr)
                {
